...
function ygf_do_header() {
  ...
  if(has_nav_menu('mobile-off-canvas')){
      echo '<div class="show-for-medium-up"><nav class="top-bar" data-topbar>';
  }else{
  ...
  if(has_nav_menu('mobile-off-canvas')){
    echo '</nav></div><div class="show-for-small-only"><nav class="tab-bar">';

    genesis_markup( array(
      'html5' => '<section class="middle tab-bar-section">',
      'xhtml' => '<div class="middle tab-bar-section">'
    ));
    ...
    genesis_markup( array(
      'html5' => '<section class="left-small">',
      'xhtml' => '<div class="left-small">'
    ));

      echo '<a href="#" class="left-off-canvas-toggle menu-icon"><span></span></a>';
